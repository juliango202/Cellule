...
//
#ifndef __CWcomposeReals_h__
#define __CWcomposeReals_h__
...
//! \date   Year Month Day
//!
class CWcomposeReals : public NWnode
{
public:
                                CWcomposeReals  ( void      );

    virtual CFtype              type            ( void      ) const { return CWcomposeRealsType; }
    static NWnode*              creator         ( void      )       { return new CWcomposeReals; }
